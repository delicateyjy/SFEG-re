...
def find_dataset_using_name(dataset_name):
    ...
    参数:
        dataset_name: 例如 "tut" 或 "crack"
    
    工作流程:
        1. 构造文件名: "datasets.tut_dataset"
        2. 动态导入模块: importlib.import_module()
        3. 查找类名: "tutdataset" (忽略大小写和下划线)
        4. 验证继承: 必须继承自 BaseDataset
    """
...
def create_dataset(args):
    ...
    返回:
        CustomDatasetDataLoader 实例,支持迭代
    """
